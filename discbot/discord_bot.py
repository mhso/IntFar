...
class DiscordClient(discord.Client):
    ...
    async def handle_game_over(self, game: str, game_info: dict, guild_id: int):
        ...
        try: # Get formatted stats that are relevant for the players in the game.
            stat_parser = get_stat_parser(game, game_info, self.api_clients[game], self.database.game_users[game], guild_id)
    ...
    def resolve_bets(self, game_stats: GameStats):
        ...
        for disc_id in self.database.game_users[game_stats.game].keys():
