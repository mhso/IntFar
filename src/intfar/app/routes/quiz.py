...
def reset_questions():
    ...
    used_questions_file = f"{config.static_folder}/quiz_used.json"
...
def active_quiz(quiz_round, question):
    ...
    question_order_file = f"{config.static_folder}/quiz_order.json"
    ...
    questions_file = f"{config.static_folder}/quiz_questions.json"
    used_questions_file = f"{config.static_folder}/quiz_used.json"
