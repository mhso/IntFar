...
from intfar.api.awards import get_doinks_reasons
...
def get_doinks_awards(game, database):
    ...
    avatars = {
        disc_id: flask.url_for("static", _external=True, filename=get_relative_static_folder(avatars[disc_id], database.config))
