...
class Config:
    def __init__(self):
        ...
        self.project_root = "/".join(file_split[:-4])
        self.startup_folder = "/".join(file_split[:-3])
        self.src_folder = f"{self.startup_folder}/intfar"
        self.resources_folder = f"{self.project_root}/resources"
        self.misc_folder = f"{self.project_root}/misc"
        self.static_folder = f"{self.src_folder}/app/static"
